...
<template>
  ...
  <div id="wrap">
            ...
            <tr>
              ...
              <td class="file">
                <router-link to="/indexGuide"
                  >@/views/indexGuide.vue</router-link
                >
              </td>
              <td>2024.04.05</td>
              <td>2024.04.08</td>
              ...
              <td>
                <ul class="log">
                  ...
                  <li class="flex">
                    ...
                    <div class="txt">
                      그냥 수정해봄 그냥 수정해봄 그냥 수정해봄 그냥 수정해봄
                    </div>
                  </li>
                  <!-- // log - li -->
                  ...
                  <li class="flex">
                    ...
                    <div class="txt">
                      오늘도 수정해봄 오늘도 수정해봄 오늘도 수정해봄 오늘도
                      수정해봄
                    </div>
                  </li>
                  <!-- // log - li -->
    ...
    <!-- // cont -->
    <codeLab01 id="codeLab01" />

    <codeLab02 id="codeLab02" />

    <codeLab03 id="codeLab03" />

    <codeLab04 id="codeLab04" />
